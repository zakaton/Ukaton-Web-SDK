...
AFRAME.registerComponent("orbit-controls", {
  ...
  init: function () {
    ...
    //this.camera = el.getObject3D('camera')
    this.camera.position.copy(this.data.initialPosition);
  },
  ...
  tick: function () {
    ...
    if (this.data.targetObject) {
      //this.data.targetObject.object3D.getWorldPosition(controls.target);
    }
